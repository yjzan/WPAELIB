(function($, yjzan) {
    ...
    var PremiumFbChatHandler = function($scope, $) {
        ...
        if (premiumFbChat.length > 0) {
            if (premiumFbChatSettings["hideMobile"]) {
                if ($(window).outerWidth() > 767) {
                    ...
                    (function(a, b, c) {
                        ...
                        a.getElementById(c) || ((a = a.createElement(b)), (a.id = c), (a.src = "https://connect.facebook.net/" + premiumFbChatSettings["lang"] + "/sdk/xfbml.customerchat.js"), d.parentNode.insertBefore(a, d))
            ...
            $(".yjzan-element-overlay .yjzan-editor-element-remove").on("click", function() {
                var $this = $(this);
                parentId = $this.parents("section.yjzan-element");
    ...
    var PremiumNotBarHandler = function($scope, $) {
        ...
        if (_this.length > 0) {
            ...
            if (!yjzanFrontend.isEditMode() && !$("body").hasClass("logged-in")) {
                    ...
                    tooltips: {
                        ...
                        callbacks: {
                            label: function(tooltipItem, data) {
                                ...
                                return (prefixString + (premiumChartSettings["percentage"] ? percentage + "%" : currentValue))
                            }
                        }
                    },
                    legend: {
            ...
            premiumChartData.forEach(function(element) {
                if (type != "pie" && type != "doughnut") {
                    var gradient = ctx.createLinearGradient(0, 0, 0, 600),
                        secondColor = element.backgroundColor[1] ? element.backgroundColor[1] : element.backgroundColor[0];
    ...
    var PremiumInstaFeedHandler = function($scope, $) {
        ...
        var template = '<div class="premium-insta-feed premium-insta-box"><div class="premium-insta-feed-inner"><div class="premium-insta-feed-wrap"><div class="premium-insta-img-wrap"><img src="{{image}}"/></div><div class="premium-insta-info-wrap"><div class="premium-insta-likes-comments">' + premiumInstaSettings["likes"] + premiumInstaSettings["comments"] + "</div></div>" + premiumInstaSettings["link"] + "</div></div></div>";
    ...
    window.CBPFWTabs = function(t, i) {
        ...
        self._init = function() {
            ...
            self.items = [].slice.call(self.el.querySelectorAll(".premium-content-wrap > section"));
            self.current = -1;
        ...
        self._show = function(t) {
            self.current >= 0 && (self.tabs[self.current].className = self.items[self.current].className = "premium-tabs-content-section"), (self.current = void 0 != t ? t : self.options.start >= 0 && self.options.start < self.items.length ? self.options.start : 0), (self.tabs[self.current].className = "premium-tabs-nav-list-item tab-current"), (self.items[self.current].className = "premium-tabs-content-section content-current")
        };
    ...
    var PremiumMagicSectionHandler = function($scope, $) {
        ...
        var premiumMagicSectionElem = $scope.find(".premium-magic-section-wrap"),
            ...
            offset, offsetAw, gutter, inIcon = premiumMagicSectionSettings["inIcon"],
    ...
    var PremiumGradientHandler = function($scope, $) {
        ...
        function generateEditorSettings(targetId) {
            var editorElements = null,
                ...
                settings = [];
            if (!window.yjzan.hasOwnProperty("elements")) {
                return false
            }
            editorElements = window.yjzan.elements;
            ...
            $.each(editorElements.models, function(index, elem) {
                ...
                } else if (elem.id == target.closest(".yjzan-top-section").data("id")) {
    ...
    var PremiumParticlesHandler = function($scope, $) {
        ...
        function generateEditorSettings(targetId) {
            ...
            if(sectionData["premium_particles_switcher"]!='yes')
            {
                return false;
            }
            ...
            settings.push(sectionData["particles_type"]);
            if (0 !== settings.length) {
                return settings
            }
            return false
        ...
        function generateParticles() {
            ...
            var output ='';
            if(settings[3]=='type1')
                output = parallax_type1;
            else if(settings[3]=='type2')
                output =parallax_type2;
            else if(settings[3]=='type3')
                output = parallax_type3;
            else if(settings[3]=='type4')
                output = parallax_type4;
            else if(settings[3]=='type_custom')
                output=settings[1];
            else
                output='';

            particlesJS("premium-section-particles-" + sectionId, JSON.parse(output));
    ...
    var parallax_type1 =  '{"particles":{"number":{"value":60,"density":{"enable":true,"value_area":800}},"color":{"value":"#ffffff"},"shape":{"type":"circle","stroke":{"width":0,"color":"#000000"},"polygon":{"nb_sides":5},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":0.5,"random":false,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":6,"random":true,"anim":{"enable":false,"speed":40,"size_min":0.1,"sync":false}},"line_linked":{"enable":true,"distance":0,"color":"#ffffff","opacity":0.4,"width":1},"move":{"enable":true,"speed":3,"direction":"none","random":false,"straight":false,"out_mode":"out","attract":{"enable":false,"rotateX":600,"rotateY":1200}}},"interactivity":{"detect_on":"canvas","events":{"onhover":{"enable":false,"mode":"repulse"},"onclick":{"enable":true,"mode":"push"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"distance":400,"size":40,"duration":2,"opacity":8,"speed":3},"repulse":{"distance":200},"push":{"particles_nb":4},"remove":{"particles_nb":2}}},"retina_detect":true,"config_demo":{"hide_card":false,"background_color":"#b61924","background_image":"","background_position":"50% 50%","background_repeat":"no-repeat","background_size":"cover"}}';
    var parallax_type2 =  '{"particles":{"number":{"value":60,"density":{"enable":true,"value_area":800}},"color":{"value":"#ffffff"},"shape":{"type":"circle","stroke":{"width":0,"color":"#000000"},"polygon":{"nb_sides":5},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":0.5,"random":false,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":6,"random":true,"anim":{"enable":false,"speed":40,"size_min":0.1,"sync":false}},"line_linked":{"enable":true,"distance":0,"color":"#ffffff","opacity":0.4,"width":1},"move":{"enable":true,"speed":3,"direction":"bottom","random":false,"straight":false,"out_mode":"out","attract":{"enable":false,"rotateX":600,"rotateY":1200}}},"interactivity":{"detect_on":"canvas","events":{"onhover":{"enable":false,"mode":"repulse"},"onclick":{"enable":true,"mode":"push"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"distance":400,"size":40,"duration":2,"opacity":8,"speed":3},"repulse":{"distance":200},"push":{"particles_nb":4},"remove":{"particles_nb":2}}},"retina_detect":true,"config_demo":{"hide_card":false,"background_color":"#b61924","background_image":"","background_position":"50% 50%","background_repeat":"no-repeat","background_size":"cover"}}';
    var parallax_type3 =  '{"particles":{"number":{"value":80,"density":{"enable":true,"value_area":800}},"color":{"value":"#ffffff"},"shape":{"type":"circle","stroke":{"width":0,"color":"#000000"},"polygon":{"nb_sides":5},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":0.5,"random":false,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":6,"random":true,"anim":{"enable":false,"speed":40,"size_min":0.1,"sync":false}},"line_linked":{"enable":true,"distance":150,"color":"#ffffff","opacity":0.4,"width":1},"move":{"enable":true,"speed":3,"direction":"none","random":false,"straight":false,"out_mode":"out","attract":{"enable":false,"rotateX":600,"rotateY":1200}}},"interactivity":{"detect_on":"canvas","events":{"onhover":{"enable":false,"mode":"repulse"},"onclick":{"enable":true,"mode":"push"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"distance":400,"size":40,"duration":2,"opacity":8,"speed":3},"repulse":{"distance":200},"push":{"particles_nb":4},"remove":{"particles_nb":2}}},"retina_detect":true,"config_demo":{"hide_card":false,"background_color":"#b61924","background_image":"","background_position":"50% 50%","background_repeat":"no-repeat","background_size":"cover"}}';
    var parallax_type4 =  '{"particles":{"number":{"value":60,"density":{"enable":true,"value_area":800}},"color":{"value":"#ffffff"},"shape":{"type":"star","stroke":{"width":0,"color":"#000000"},"polygon":{"nb_sides":5},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":0.5,"random":false,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":6,"random":true,"anim":{"enable":false,"speed":40,"size_min":0.1,"sync":false}},"line_linked":{"enable":true,"distance":0,"color":"#ffffff","opacity":0.4,"width":1},"move":{"enable":true,"speed":3,"direction":"none","random":true,"straight":false,"out_mode":"out","attract":{"enable":false,"rotateX":600,"rotateY":1200}}},"interactivity":{"detect_on":"canvas","events":{"onhover":{"enable":false,"mode":"repulse"},"onclick":{"enable":true,"mode":"push"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"distance":400,"size":40,"duration":2,"opacity":8,"speed":3},"repulse":{"distance":200},"push":{"particles_nb":4},"remove":{"particles_nb":2}}},"retina_detect":true,"config_demo":{"hide_card":false,"background_color":"#b61924","background_image":"","background_position":"50% 50%","background_repeat":"no-repeat","background_size":"cover"}}';
    ...
    var PremiumParallaxHandler = function($scope, $) {
        ...
        function generateMultiLayers() {
            ...
            target.mousemove(function(e) {
                $(this).find('.premium-parallax-layer[data-parallax="true"]').each(function() {
                    var $this = $(this),
                        resistance = $(this).data("rate");
                    TweenLite.to($this, 0.2, {
                        x: -((e.clientX - window.innerWidth / 2) / resistance),
    ...
    var PremiumScrollHandler = function($scope, $) {
        ...
        var leftTemps = $(premiumScrollElem).find(".premium-multiscroll-left-temp"),
            ...
            deviceType = $("body").data("yjzan-device-mode");
        ...
        function reOrderTemplates() {
            $(premiumScrollElem).parents(".yjzan-top-section").removeClass("yjzan-section-height-full");
    ...
    $(window).on("yjzan/frontend/init", function() {
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-flip-box.default", PremiumFlipboxHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-unfold-addon.default", PremiumUnfoldHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-facebook-chat.default", PremiumFbChatHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-notbar.default", PremiumNotBarHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-chart.default", PremiumChartHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-tabs.default", PremiumTabsHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-magic-section.default", PremiumMagicSectionHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-preview-image.default", PremiumPreviewWindowHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-img-layers-addon.default", PremiumImageLayersHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-image-comparison.default", PremiumImageCompareHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-content-toggle.default", PremiumContentToggleHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-addon-image-hotspots.default", PremiumImageHotspotHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-tables-addon.default", PremiumTableHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-divider.default", PremiumDividerHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/premium-multi-scroll.default", PremiumScrollHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/section", PremiumGradientHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/section", PremiumParticlesHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/section", PremiumParallaxHandler);
        yjzanFrontend.hooks.addAction("frontend/element_ready/column", PremiumBadgeHandler);
        if (yjzanFrontend.isEditMode()) {} else {}
    })
